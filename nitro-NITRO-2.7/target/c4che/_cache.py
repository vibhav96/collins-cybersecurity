...
INCLUDES_UNITTEST = ['/vagrant/nitro-NITRO-2.7/c++/include']
IS64BIT = True
...
STLIB_ST = '-l%s'
VARIANT = 'x86_64-unknown-linux-gnu-release-64'
VERSION = '2.7'
cprogram_PATTERN = '%s'
